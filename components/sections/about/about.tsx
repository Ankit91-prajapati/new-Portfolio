const About = () => {
  return (
    <section id="about" className="w-screen md:w-[80vw] mx-2 md:mx-auto px-10  py-12">
      ...
      <p className="mt-4  text-base md:text-2xl leading-[30px]  text-black dark:text-white">
        ...
        problems. I am a quick learner and love collaborating with
        teams and clients to bring ideas to life.
      </p>
